...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleUserNotFounf(UserNotFoundException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleUserNotFounf(EmailNotFoundException ex) {
